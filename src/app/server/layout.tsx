...
const navItems = [
  { href: '/server/new-order', label: 'New Order', icon: PlusCircle },
  { href: '/server/old-order', label: 'Old Order', icon: ClipboardList },
  { href: '/server/my-orders', label: 'My Orders', icon: ClipboardCheck },
  { href: '/server/order-history', label: 'Order History', icon: History },
];
                  ...
                  <div className="p-4 border-b">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Server: {user?.username}</p>
                      </div>
                    </div>
                  </div>
